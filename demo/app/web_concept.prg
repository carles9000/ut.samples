...
including versions of Lorem Ipsum.
	...
	DEFINE WEB oWeb TITLE 'Get Button' 
		...
		NAV oNav ID 'nav' TITLE '&nbsp;Test Controls' LOGO "files/images/mercury_mini.png" ;
			ROUTE '/' WIDTH 35 HEIGHT 35 OF oWeb
    ...
    DEFINE FORM o ID 'concept' API 'api_concept' ON INIT 'hello' OF oWeb
		...
		INIT FORM o  
			...
			ROWGROUP o
				...
				GET oMemo MEMO ID 'memo' VALUE cTxt LABEL 'Loren Ipsum' ROWS 5 GRID 12 ONCHANGE 'showmemo' OF o
