	...
	ROW o CLASS 'mycontainer'
		...
		COL o GRID 0 CLASS 'myblock'
			...
			ROWGROUP o	HALIGN 'center'															
				GET ID HB_HGetDef( hData, 'id_user', 'user' )  VALUE '' GRID 12 PLACEHOLDER HB_HGetDef( hData, 'user_placeholder', '' );
					LABEL '<i class="fa fa-user" aria-hidden="true"></i>&nbsp;User'  ;
					OF o						
			ENDROW o	

			ROWGROUP o																
				GET ID HB_HGetDef( hData, 'id_psw', 'psw' )  TYPE 'password' VALUE '' GRID 12 PLACEHOLDER HB_HGetDef( hData, 'psw_placeholder', '' );
